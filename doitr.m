...
NAMEST = {'A_TTS' 'A_SnGo' 'A_Male' 'A_ALT40ELT8' 'A_AGT40EGT8'};
NAMEME = {'Bc_1' 'Bc_2' 'LV_Load' 'Mu_12' 'Mu_13' 'Mu_14' 'Mu_22' 'Mu_23' 'Mu_24'};
NAMECH = {'C_TT' 'C_VRC' 'C_VRCLV'};
...
% Choice coefficients
% chc=[-0.1 -0.1 -0.1];
chc=[-0.1 0 -0.1];  % Keeping TC coeff to be ZERO.. Just in case!
nchc=size(chc,2);
...
lb=[-100 -100 -100 -100 -100 -100 -100 -100 -100 -100 -100 -100 -100 -100 -100 0 -100];
ub=[100 100 100 100 100 100 100 100 100 100 100 100 100 100 100 0 100];
